    ...
    <div className="bg-[#f1f2f5] py-10 px-6 w-full ">
      <div className="flex flex-col lg:flex-row justify-between items-start gap-6 lg:gap-16 max-w-screen-2xl mx-auto">
        ...
        <div className="lg:w-1/2">
          <p className="text-orange-500 font-semibold text-3xl md:text-4xl mb-2 mt-9 mb-2">Why Choose</p>
        ...
        {/* Right: Description */}
        <div className="lg:w-1/2 border-l-4 border-orange-500 pl-4 text-[1.2rem] md:text-[1.8rem] text-gray-1000 mt-3 md:mt-12 ">
